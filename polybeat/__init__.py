...
def play(n_edges=[1, 12, 4, 3], vols=[0, -2, -6, -10]):
    class Polybeat(Scene):
        def construct(self):
            dr = .16
            colors = ['#ff7473', '#ffc952', '#47b8e0', '#63e663']
            N = len(n_edges)
            op = .4
            T = 1.8
            sounds = ['kick_drum', 'open_conga', 'low_bongo', 'snare']
            ...
            geoms = [Polygon(*v).set_stroke(colors[i], 14, op)
